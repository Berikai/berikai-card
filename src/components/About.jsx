    ...
    return (
        <div className="App-about">
            ...
            <p className="socials" align="left">
                ...
                <a className="padding-inline" href="https://www.github.com/Berikai" target="_blank" rel="noreferrer"><img src="https://raw.githubusercontent.com/danielcranney/readme-generator/main/public/icons/socials/github.svg" width="24" height="24" alt="Github"/></a>
                ...
                <a className="padding-inline" href="https://www.twitter.com/verdantbass" target="_blank" rel="noreferrer"><img src="https://raw.githubusercontent.com/danielcranney/readme-generator/main/public/icons/socials/twitter.svg" width="24" height="24" alt="Twitter"/></a>
            </p>
        </div>
    )
}